...
public class InterceptorConfiguration implements WebMvcConfigurer {
    ...
    public InterceptorConfiguration(IdempotentService idempotentService, ISessionService sessionService) {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        /* 请求上下文注入 */
        registry.addInterceptor(new RequestContextInterceptor(sessionService)).addPathPatterns("/**");
        /* 拦截幂等性校验 token key */
