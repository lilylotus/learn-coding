...
//        String clazzPath = "C:\\programming\\idea\\future\\practice\\out\\production\\classes\\cn/nihility/jvm/MyClassExt.class";
    ...
    public static void main(String[] args) throws ClassNotFoundException {
        ...
        System.out.println("-----------------");
        Class<?> clazz1 = getSystemClassLoader().loadClass("cn.nihility.jvm.MyClassExt");
        ...
        /*AutoCompileAndExecuteThread ac = new AutoCompileAndExecuteThread("cn.nihility.jvm.MyClassExt");
        ac.start();*/
...
//        String cmd = "ls /";
    ...
    public static void main1(String[] args) {
        ...
        try {
            Class<?> clazz = loader.loadClass("cn.nihility.jvm.MyClassExt");
//            Class<?> clazz2 = loader.loadClass("cn.nihility.jvm.MyClassExt");
//            Class<?> clazz2 = loader2.loadClass("cn.nihility.jvm.MyClassExt");
