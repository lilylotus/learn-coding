package cn.nihility.boot.controller.advice;

import cn.nihility.boot.controller.ret.ResponseResultBody;
import cn.nihility.boot.controller.ret.ResultException;
...
/**
 * 统一返回数据封装，此仅对注解了 @ResponseResultBody Controller 拦截
 */
    ...
    public Object beforeBodyWrite(Object body, MethodParameter returnType, MediaType selectedContentType, Class<? extends HttpMessageConverter<?>> selectedConverterType, ServerHttpRequest request, ServerHttpResponse response) {
        ...
        if (body instanceof ResultResponse) {
            ...
            return "{" +
                    "\"apiVersion\"" + ":" + "\"1.0.0\"," +
                    "\"data\"" + ":" + "\"" + body + "\"," +
                    "\"message\"" + ":" + "\"ResponseResultBody 注解统一请求\"" +
                    "}";
        } else if ("application".equals(selectedContentType.getType())
                && "json".equals(selectedContentType.getSubtype())) {
