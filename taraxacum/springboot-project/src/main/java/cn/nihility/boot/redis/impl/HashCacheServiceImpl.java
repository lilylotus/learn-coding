package cn.nihility.boot.redis.impl;

import cn.nihility.boot.redis.HashCacheService;
...
public class HashCacheServiceImpl implements HashCacheService {
    ...
    @Override
    public Boolean putAll(String key, Map<String, Object> items) {
        redisTemplate.boundHashOps(key).putAll(items);
        return Boolean.TRUE;
    }
}
