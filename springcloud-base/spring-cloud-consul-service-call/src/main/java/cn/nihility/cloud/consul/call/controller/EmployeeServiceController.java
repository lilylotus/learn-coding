package cn.nihility.cloud.consul.call.controller;

import cn.nihility.cloud.consul.call.entity.Employee;
...
public class EmployeeServiceController {
    ...
    private static final String IP_SERVICE = "http://localhost:53003/consul";
    private static final String PER_SERVICE = "spring-cloud-consul-service-provider";
    private static final String REST_PER_SERVICE = "http://spring-cloud-consul-service-provider/consul";
