...
import cn.nihility.plugin.servlet.exception.HttpRequestException;
...
public class GlobalExceptionHandler {
    ...
    @Autowired
    public void setDebugStackTrace(@Value("${api.unify.exception.debugStackTrace:false}") boolean debugStackTrace) {
